...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpHhN2u8/lowParentAge.csv.
...
The current date and time is 2026-06-23 19:33:25.475245. The processing

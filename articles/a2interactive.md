...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpLVIXXW/lowParentAge.csv.
...
The current date and time is 2026-07-17 14:48:58.184401. The processing

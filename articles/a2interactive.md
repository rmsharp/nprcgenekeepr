...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpJ7dNTs/lowParentAge.csv.
...
The current date and time is 2026-07-07 02:52:31.184587. The processing

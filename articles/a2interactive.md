...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp1kjkLg/lowParentAge.csv.
...
The current date and time is 2026-07-15 05:04:14.179115. The processing

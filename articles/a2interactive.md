...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpRuPAEO/lowParentAge.csv.
...
The current date and time is 2026-08-26 04:17:12.139746. The processing

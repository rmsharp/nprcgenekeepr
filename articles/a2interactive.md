...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpGT9Sh2/lowParentAge.csv.
...
The current date and time is 2026-06-22 03:20:32.994129. The processing

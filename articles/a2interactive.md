...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpXvaKPy/lowParentAge.csv.
...
The current date and time is 2026-07-04 20:51:56.976784. The processing

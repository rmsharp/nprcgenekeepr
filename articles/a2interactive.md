...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpJXDzix/lowParentAge.csv.
...
The current date and time is 2026-06-28 10:07:03.225515. The processing

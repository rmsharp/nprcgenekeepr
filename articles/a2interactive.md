...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp1441hV/lowParentAge.csv.
...
The current date and time is 2026-08-20 16:09:24.895666. The processing

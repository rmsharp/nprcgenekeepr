...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpS8s5ia/lowParentAge.csv.
...
The current date and time is 2026-07-29 06:42:10.385423. The processing

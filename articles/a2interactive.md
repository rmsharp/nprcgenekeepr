...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpMTrZ8c/lowParentAge.csv.
...
The current date and time is 2026-07-18 19:31:11.030329. The processing

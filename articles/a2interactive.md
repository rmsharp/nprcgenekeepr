...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpTD3tgO/lowParentAge.csv.
...
The current date and time is 2026-07-08 23:04:26.320304. The processing

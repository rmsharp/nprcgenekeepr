...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp2ZSobd/lowParentAge.csv.
...
The current date and time is 2026-08-26 19:14:45.402698. The processing

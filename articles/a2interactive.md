...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpX4UP2x/lowParentAge.csv.
...
The current date and time is 2026-06-28 21:21:33.208175. The processing

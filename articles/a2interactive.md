...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpKtY6dS/lowParentAge.csv.
...
The current date and time is 2026-07-30 18:17:01.639285. The processing

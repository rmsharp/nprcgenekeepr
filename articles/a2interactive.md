...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp8Cy7zX/lowParentAge.csv.
...
The current date and time is 2026-08-30 00:21:19.184396. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpv1RRl9/lowParentAge.csv.
...
The current date and time is 2026-06-23 14:59:12.704359. The processing

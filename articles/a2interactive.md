...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpu7ru1w/lowParentAge.csv.
...
The current date and time is 2026-06-30 23:55:30.469273. The processing

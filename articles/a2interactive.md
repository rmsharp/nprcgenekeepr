...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpVZAsSn/lowParentAge.csv.
...
The current date and time is 2026-06-25 19:14:32.760565. The processing

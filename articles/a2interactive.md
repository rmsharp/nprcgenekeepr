...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpVaX6cF/lowParentAge.csv.
...
The current date and time is 2026-07-12 21:29:22.430855. The processing

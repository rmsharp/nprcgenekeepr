...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpMp9S65/lowParentAge.csv.
...
The current date and time is 2026-08-03 18:49:35.496505. The processing

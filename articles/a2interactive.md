...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp7Km9Ny/lowParentAge.csv.
...
The current date and time is 2026-06-29 05:45:41.51276. The processing

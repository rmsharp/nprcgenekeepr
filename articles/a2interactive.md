...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpexxTHL/lowParentAge.csv.
...
The current date and time is 2026-06-24 15:17:01.884424. The processing

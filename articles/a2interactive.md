...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp4syL4a/lowParentAge.csv.
...
The current date and time is 2026-07-07 18:35:38.947997. The processing

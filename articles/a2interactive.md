...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpatbPeV/lowParentAge.csv.
...
The current date and time is 2026-07-17 02:49:56.275981. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpkAP613/lowParentAge.csv.
...
The current date and time is 2026-08-20 18:31:22.968093. The processing

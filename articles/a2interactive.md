...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpLBCU7o/lowParentAge.csv.
...
The current date and time is 2026-06-20 20:02:31.540543. The processing

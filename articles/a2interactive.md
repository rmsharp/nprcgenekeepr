...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpkZuAyb/lowParentAge.csv.
...
The current date and time is 2026-07-10 02:25:31.784269. The processing

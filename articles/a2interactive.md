...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpcq4XUg/lowParentAge.csv.
...
The current date and time is 2026-07-11 00:31:40.961915. The processing

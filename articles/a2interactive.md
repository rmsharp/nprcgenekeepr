...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpuFcIJc/lowParentAge.csv.
...
The current date and time is 2026-07-17 15:04:12.733877. The processing

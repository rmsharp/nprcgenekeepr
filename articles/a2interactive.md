...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpJKRXTU/lowParentAge.csv.
...
The current date and time is 2026-07-31 04:49:09.001391. The processing

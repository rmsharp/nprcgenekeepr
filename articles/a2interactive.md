...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpms8O4B/lowParentAge.csv.
...
The current date and time is 2026-07-16 05:57:51.121854. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp3xs00N/lowParentAge.csv.
...
The current date and time is 2026-06-22 13:03:27.056993. The processing

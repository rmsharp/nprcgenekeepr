...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpV9JhJz/lowParentAge.csv.
...
The current date and time is 2026-07-30 22:47:29.521381. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpSXuY0I/lowParentAge.csv.
...
The current date and time is 2026-08-26 20:39:53.524985. The processing

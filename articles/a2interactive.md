...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpom1kZs/lowParentAge.csv.
...
The current date and time is 2026-09-21 04:48:08.217611. The processing

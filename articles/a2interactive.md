...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpCmXpjm/lowParentAge.csv.
...
The current date and time is 2026-07-10 00:24:25.025235. The processing

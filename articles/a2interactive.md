...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpOllbGR/lowParentAge.csv.
...
The current date and time is 2026-07-12 20:14:22.834273. The processing

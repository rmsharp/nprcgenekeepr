...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpJDezgJ/lowParentAge.csv.
...
The current date and time is 2026-07-18 19:03:29.458239. The processing

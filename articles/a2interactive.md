...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpwZ3InZ/lowParentAge.csv.
...
The current date and time is 2026-08-20 16:47:17.952072. The processing

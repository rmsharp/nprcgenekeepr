...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpBGSTrK/lowParentAge.csv.
...
The current date and time is 2026-06-24 03:51:12.474612. The processing

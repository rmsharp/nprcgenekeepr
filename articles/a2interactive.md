...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpfYv1G3/lowParentAge.csv.
...
The current date and time is 2026-07-29 04:28:37.197819. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpxRtx82/lowParentAge.csv.
...
The current date and time is 2026-07-06 07:15:36.558628. The processing

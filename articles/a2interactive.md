...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpLSPMAp/lowParentAge.csv.
...
The current date and time is 2026-06-22 05:32:01.241852. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpWTq85f/lowParentAge.csv.
...
The current date and time is 2026-06-28 04:16:57.02432. The processing

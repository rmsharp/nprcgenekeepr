...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpewA0w3/lowParentAge.csv.
...
The current date and time is 2026-06-28 02:19:29.892379. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpLxHtNA/lowParentAge.csv.
...
The current date and time is 2026-09-21 00:46:11.359866. The processing

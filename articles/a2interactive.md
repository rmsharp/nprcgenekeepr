...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpfToSwl/lowParentAge.csv.
...
The current date and time is 2026-06-24 04:41:19.6183. The processing

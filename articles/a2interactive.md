...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpMkhflT/lowParentAge.csv.
...
The current date and time is 2026-06-26 01:14:15.681793. The processing

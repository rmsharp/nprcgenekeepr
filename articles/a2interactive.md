...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpzU9Kg1/lowParentAge.csv.
...
The current date and time is 2026-06-29 16:51:05.544698. The processing

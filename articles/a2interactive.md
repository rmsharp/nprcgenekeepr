...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpxs3mo6/lowParentAge.csv.
...
The current date and time is 2026-07-04 16:41:32.042495. The processing

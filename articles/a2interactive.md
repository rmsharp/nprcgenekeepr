...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpabTaRE/lowParentAge.csv.
...
The current date and time is 2026-06-22 16:17:07.404899. The processing

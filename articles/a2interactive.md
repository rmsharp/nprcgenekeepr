...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpXce7Gd/lowParentAge.csv.
...
The current date and time is 2026-09-19 07:04:35.289749. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpvmBLu7/lowParentAge.csv.
...
The current date and time is 2026-07-30 04:40:04.106727. The processing

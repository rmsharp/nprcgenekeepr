...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpRUrWU5/lowParentAge.csv.
...
The current date and time is 2026-06-22 03:12:47.635324. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp927VCx/lowParentAge.csv.
...
The current date and time is 2026-08-02 22:46:46.514242. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpPTv2Iq/lowParentAge.csv.
...
The current date and time is 2026-09-08 17:01:35.983989. The processing

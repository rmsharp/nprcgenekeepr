...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpxNPzXF/lowParentAge.csv.
...
The current date and time is 2026-09-21 17:34:58.409634. The processing

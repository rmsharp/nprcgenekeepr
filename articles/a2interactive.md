...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpiCI7Nc/lowParentAge.csv.
...
The current date and time is 2026-08-18 20:52:09.257538. The processing

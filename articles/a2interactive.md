...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpyNN4Rj/lowParentAge.csv.
...
The current date and time is 2026-07-04 19:21:03.569117. The processing

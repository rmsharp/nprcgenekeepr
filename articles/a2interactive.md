...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpsw1H5c/lowParentAge.csv.
...
The current date and time is 2026-07-06 15:49:19.93516. The processing

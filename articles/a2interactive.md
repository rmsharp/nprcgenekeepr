...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpGztk2R/lowParentAge.csv.
...
The current date and time is 2026-07-28 21:38:39.872243. The processing

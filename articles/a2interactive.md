...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpl8z3lX/lowParentAge.csv.
...
The current date and time is 2026-09-20 22:34:02.991666. The processing

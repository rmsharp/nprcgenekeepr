...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpLcksXw/lowParentAge.csv.
...
The current date and time is 2026-07-21 18:44:14.550364. The processing

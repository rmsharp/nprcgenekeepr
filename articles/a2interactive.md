...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpCHgNmc/lowParentAge.csv.
...
The current date and time is 2026-08-02 05:05:20.94362. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpVhO1gx/lowParentAge.csv.
...
The current date and time is 2026-07-28 19:30:21.300111. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpHgALIQ/lowParentAge.csv.
...
The current date and time is 2026-07-21 16:22:57.365149. The processing

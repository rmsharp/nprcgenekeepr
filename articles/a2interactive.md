...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp2wKZyz/lowParentAge.csv.
...
The current date and time is 2026-07-06 00:39:29.176433. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmprUFMmt/lowParentAge.csv.
...
The current date and time is 2026-07-09 04:29:17.996131. The processing

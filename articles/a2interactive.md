...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpqPc8t3/lowParentAge.csv.
...
The current date and time is 2026-07-06 21:21:42.5552. The processing

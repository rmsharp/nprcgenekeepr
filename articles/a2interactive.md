...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpox9dZj/lowParentAge.csv.
...
The current date and time is 2026-08-26 03:28:18.539. The processing

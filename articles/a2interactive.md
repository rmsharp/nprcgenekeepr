...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpuYleGt/lowParentAge.csv.
...
The current date and time is 2026-08-22 19:34:34.170017. The processing

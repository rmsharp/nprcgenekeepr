...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmprboF5T/lowParentAge.csv.
...
The current date and time is 2026-08-03 01:37:26.337464. The processing

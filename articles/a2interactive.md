...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpkn6mgW/lowParentAge.csv.
...
The current date and time is 2026-06-26 20:56:42.366168. The processing

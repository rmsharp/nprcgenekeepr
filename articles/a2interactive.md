...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpdpc9GF/lowParentAge.csv.
...
The current date and time is 2026-07-09 19:25:08.851329. The processing

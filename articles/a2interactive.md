...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpTIaWfq/lowParentAge.csv.
...
The current date and time is 2026-06-21 23:05:46.630012. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpYAgcxk/lowParentAge.csv.
...
The current date and time is 2026-09-18 19:49:08.928798. The processing

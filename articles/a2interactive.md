...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpMqyroI/lowParentAge.csv.
...
The current date and time is 2026-07-18 02:28:07.88633. The processing

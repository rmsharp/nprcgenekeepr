...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpWn8kXA/lowParentAge.csv.
...
The current date and time is 2026-06-28 04:10:22.63681. The processing

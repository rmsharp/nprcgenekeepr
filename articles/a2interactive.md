...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpxHGklQ/lowParentAge.csv.
...
The current date and time is 2026-09-24 00:54:18.121757. The processing

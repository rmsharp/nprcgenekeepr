...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpn02nXZ/lowParentAge.csv.
...
The current date and time is 2026-08-19 20:25:43.000162. The processing

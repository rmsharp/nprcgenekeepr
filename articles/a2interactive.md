...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpng5CkT/lowParentAge.csv.
...
The current date and time is 2026-07-04 22:19:49.570175. The processing

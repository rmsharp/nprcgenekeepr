...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpMDxq9b/lowParentAge.csv.
...
The current date and time is 2026-07-29 22:17:48.380642. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpQcwSoR/lowParentAge.csv.
...
The current date and time is 2026-06-22 13:21:31.240886. The processing

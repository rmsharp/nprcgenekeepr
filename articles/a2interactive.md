...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpr1GFfr/lowParentAge.csv.
...
The current date and time is 2026-06-28 21:05:27.045367. The processing

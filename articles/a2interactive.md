...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp9QSZJY/lowParentAge.csv.
...
The current date and time is 2026-07-15 20:33:24.632019. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpCafj4W/lowParentAge.csv.
...
The current date and time is 2026-07-21 17:52:15.404441. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmptZcxDI/lowParentAge.csv.
...
The current date and time is 2026-07-05 13:55:35.340283. The processing

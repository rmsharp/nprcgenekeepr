...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpdakqzs/lowParentAge.csv.
...
The current date and time is 2026-07-07 03:29:47.948617. The processing

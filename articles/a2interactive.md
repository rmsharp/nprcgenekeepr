...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmprV05Xt/lowParentAge.csv.
...
The current date and time is 2026-07-09 04:40:49.116696. The processing

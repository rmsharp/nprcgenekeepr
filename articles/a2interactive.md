...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmphwPVZY/lowParentAge.csv.
...
The current date and time is 2026-07-29 05:45:51.204742. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpoDGdSW/lowParentAge.csv.
...
The current date and time is 2026-06-22 04:33:09.742502. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp3FYTJ6/lowParentAge.csv.
...
The current date and time is 2026-08-02 00:48:59.891141. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpSDlS6T/lowParentAge.csv.
...
The current date and time is 2026-08-26 19:03:41.009823. The processing

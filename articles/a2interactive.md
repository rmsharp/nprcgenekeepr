...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp7X5tqK/lowParentAge.csv.
...
The current date and time is 2026-07-04 21:10:33.291321. The processing

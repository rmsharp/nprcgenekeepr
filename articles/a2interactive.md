...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp2iXhlq/lowParentAge.csv.
...
The current date and time is 2026-07-06 15:55:29.540178. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpNbR7UB/lowParentAge.csv.
...
The current date and time is 2026-07-09 05:06:28.763764. The processing

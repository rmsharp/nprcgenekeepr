...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpsYWdQD/lowParentAge.csv.
...
The current date and time is 2026-06-23 14:52:44.489924. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpY6kHXG/lowParentAge.csv.
...
The current date and time is 2026-06-25 10:41:08.652436. The processing

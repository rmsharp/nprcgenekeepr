...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpfT8jZl/lowParentAge.csv.
...
The current date and time is 2026-07-06 16:36:51.352423. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpBJOPB7/lowParentAge.csv.
...
The current date and time is 2026-06-25 02:34:02.362983. The processing

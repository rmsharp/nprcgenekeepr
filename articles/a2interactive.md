...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp4reXaj/lowParentAge.csv.
...
The current date and time is 2026-07-15 02:32:21.705593. The processing

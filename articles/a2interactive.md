...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpW62J9s/lowParentAge.csv.
...
The current date and time is 2026-09-20 05:12:49.068788. The processing

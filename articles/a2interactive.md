...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp7K9pNo/lowParentAge.csv.
...
The current date and time is 2026-07-06 02:45:51.614021. The processing

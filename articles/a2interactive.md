...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpJCpFXr/lowParentAge.csv.
...
The current date and time is 2026-06-28 23:05:16.632207. The processing

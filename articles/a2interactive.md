...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpBvnTL6/lowParentAge.csv.
...
The current date and time is 2026-07-29 06:22:26.336288. The processing

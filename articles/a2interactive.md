...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpKrazhx/lowParentAge.csv.
...
The current date and time is 2026-08-18 21:39:17.264602. The processing

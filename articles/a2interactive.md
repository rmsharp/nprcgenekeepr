...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpoe7NSl/lowParentAge.csv.
...
The current date and time is 2026-06-17 04:06:33.944779. The processing

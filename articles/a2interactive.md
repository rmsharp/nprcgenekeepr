...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpyODcrh/lowParentAge.csv.
...
The current date and time is 2026-07-12 16:24:28.488063. The processing

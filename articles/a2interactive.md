...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpvzVBzq/lowParentAge.csv.
...
The current date and time is 2026-08-15 22:27:44.65165. The processing

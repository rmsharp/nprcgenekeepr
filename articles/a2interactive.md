...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpFdEsKQ/lowParentAge.csv.
...
The current date and time is 2026-07-07 00:01:44.377931. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpj5JAZA/lowParentAge.csv.
...
The current date and time is 2026-07-29 23:58:49.529513. The processing

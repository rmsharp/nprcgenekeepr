...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpCV9anY/lowParentAge.csv.
...
The current date and time is 2026-07-01 01:55:47.938556. The processing

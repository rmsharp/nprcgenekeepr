...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp6ltV8b/lowParentAge.csv.
...
The current date and time is 2026-09-20 03:20:42.60484. The processing

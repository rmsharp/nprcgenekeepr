...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpepieyw/lowParentAge.csv.
...
The current date and time is 2026-07-13 16:51:41.625579. The processing

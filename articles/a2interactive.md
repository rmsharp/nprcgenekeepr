...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpqVKFd8/lowParentAge.csv.
...
The current date and time is 2026-06-24 18:13:55.866067. The processing

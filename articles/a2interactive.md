...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpKUEr0m/lowParentAge.csv.
...
The current date and time is 2026-07-12 01:27:19.610015. The processing

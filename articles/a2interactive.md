...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpLK0WDa/lowParentAge.csv.
...
The current date and time is 2026-06-19 20:44:48.652176. The processing

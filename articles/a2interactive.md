...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpYlZwgL/lowParentAge.csv.
...
The current date and time is 2026-07-16 05:31:32.135286. The processing

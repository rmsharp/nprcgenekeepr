...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpgRLI5Q/lowParentAge.csv.
...
The current date and time is 2026-08-01 22:42:08.234993. The processing

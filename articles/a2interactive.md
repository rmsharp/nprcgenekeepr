...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpYf5QvT/lowParentAge.csv.
...
The current date and time is 2026-07-30 01:17:19.762971. The processing

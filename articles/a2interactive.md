...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpDCw8rw/lowParentAge.csv.
...
The current date and time is 2026-06-22 05:37:17.56062. The processing

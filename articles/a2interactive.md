...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpSsAzbw/lowParentAge.csv.
...
The current date and time is 2026-07-29 18:03:30.090465. The processing

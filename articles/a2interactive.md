...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp05zFY6/lowParentAge.csv.
...
The current date and time is 2026-06-25 05:24:28.119216. The processing

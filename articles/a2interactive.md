...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmptcuEYs/lowParentAge.csv.
...
The current date and time is 2026-06-30 21:50:33.465797. The processing

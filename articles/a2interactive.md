...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpkzAa3m/lowParentAge.csv.
...
The current date and time is 2026-07-06 18:21:05.730664. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmplapsEe/lowParentAge.csv.
...
The current date and time is 2026-08-03 16:12:12.861819. The processing

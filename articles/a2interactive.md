...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpxRJLk1/lowParentAge.csv.
...
The current date and time is 2026-06-27 18:08:39.679419. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpXcpY1v/lowParentAge.csv.
...
The current date and time is 2026-07-09 03:40:39.290685. The processing

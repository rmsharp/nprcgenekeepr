...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmphzvTwC/lowParentAge.csv.
...
The current date and time is 2026-06-29 18:54:15.129245. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpFUfFF4/lowParentAge.csv.
...
The current date and time is 2026-06-28 23:29:31.463774. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpUopLCD/lowParentAge.csv.
...
The current date and time is 2026-07-11 18:22:50.956658. The processing

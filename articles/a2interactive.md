...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmptSgTYw/lowParentAge.csv.
...
The current date and time is 2026-09-20 01:46:16.714968. The processing

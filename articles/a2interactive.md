...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp7lUfT6/lowParentAge.csv.
...
The current date and time is 2026-06-24 19:14:37.27423. The processing

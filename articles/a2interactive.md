...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmproP9aM/lowParentAge.csv.
...
The current date and time is 2026-07-09 23:26:55.583639. The processing

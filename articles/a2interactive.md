...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp1Oa28s/lowParentAge.csv.
...
The current date and time is 2026-07-09 18:40:31.464946. The processing

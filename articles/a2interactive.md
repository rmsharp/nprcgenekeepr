...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpcclECg/lowParentAge.csv.
...
The current date and time is 2026-08-26 12:39:56.956643. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpfqWDAM/lowParentAge.csv.
...
The current date and time is 2026-07-06 19:02:07.362309. The processing

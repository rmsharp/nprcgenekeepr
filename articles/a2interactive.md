...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpqlTbUG/lowParentAge.csv.
...
The current date and time is 2026-07-07 06:11:17.901257. The processing

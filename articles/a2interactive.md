...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmprv9HNV/lowParentAge.csv.
...
The current date and time is 2026-06-22 21:59:00.382691. The processing

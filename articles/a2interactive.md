...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpUKzBsp/lowParentAge.csv.
...
The current date and time is 2026-07-14 22:33:33.24703. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpHJVSRj/lowParentAge.csv.
...
The current date and time is 2026-07-09 22:42:37.069655. The processing

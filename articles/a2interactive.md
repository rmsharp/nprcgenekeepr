...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpe7mvOM/lowParentAge.csv.
...
The current date and time is 2026-07-06 16:43:41.793632. The processing

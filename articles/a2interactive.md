...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpdwYzf8/lowParentAge.csv.
...
The current date and time is 2026-06-30 20:51:13.694135. The processing

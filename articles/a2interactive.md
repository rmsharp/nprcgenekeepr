...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp67LXKF/lowParentAge.csv.
...
The current date and time is 2026-08-03 00:45:11.295897. The processing

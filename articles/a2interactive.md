...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmptA96D6/lowParentAge.csv.
...
The current date and time is 2026-07-29 18:19:39.068848. The processing

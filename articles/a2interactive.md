...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpgU5bGm/lowParentAge.csv.
...
```
    ...
    ## 8 o4   s2   d2   M   1 2015-09-16 <NA> 10.7     original
...
The current date and time is 2026-06-11 16:40:29.021096. The processing
...
```
    ...
    ## [69] renv_1.1.4           rstudioapi_0.18.0    jsonlite_2.0.0       R6_2.6.1            

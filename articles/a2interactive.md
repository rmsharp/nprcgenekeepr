...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpcczmxr/lowParentAge.csv.
...
The current date and time is 2026-08-15 17:33:36.665761. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpju0quh/lowParentAge.csv.
...
The current date and time is 2026-07-16 18:00:34.581729. The processing

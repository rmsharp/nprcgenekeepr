...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp4m12Au/lowParentAge.csv.
...
The current date and time is 2026-06-27 20:12:37.550058. The processing
...
```
    ...
    ## [61] shiny_1.14.0         evaluate_1.0.5       rlang_1.2.0          futile.options_1.0.1

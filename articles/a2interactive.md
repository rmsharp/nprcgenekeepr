...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpr6iAKF/lowParentAge.csv.
...
The current date and time is 2026-07-01 03:27:43.513381. The processing

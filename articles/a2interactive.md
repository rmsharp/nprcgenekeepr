...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpik0oFN/lowParentAge.csv.
...
The current date and time is 2026-06-29 02:07:58.415123. The processing

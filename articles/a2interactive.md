...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpmTaPd2/lowParentAge.csv.
...
The current date and time is 2026-06-29 08:21:16.821207. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpCCRiIY/lowParentAge.csv.
...
The current date and time is 2026-09-18 04:30:34.309438. The processing

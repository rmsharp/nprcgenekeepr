...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp2As5pW/lowParentAge.csv.
...
The current date and time is 2026-08-20 16:54:06.345798. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpPiU8DR/lowParentAge.csv.
...
The current date and time is 2026-06-29 02:14:05.287251. The processing

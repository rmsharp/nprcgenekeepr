...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp3JVp2p/lowParentAge.csv.
...
The current date and time is 2026-06-29 04:09:11.088457. The processing

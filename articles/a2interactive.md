...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmphME9om/lowParentAge.csv.
...
The current date and time is 2026-07-06 23:24:44.405337. The processing

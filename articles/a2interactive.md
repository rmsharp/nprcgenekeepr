...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpvr1wB3/lowParentAge.csv.
...
The current date and time is 2026-07-06 18:30:43.740963. The processing

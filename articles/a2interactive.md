...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpB5IAFa/lowParentAge.csv.
...
The current date and time is 2026-07-09 19:39:34.539171. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpCWd60m/lowParentAge.csv.
...
The current date and time is 2026-08-20 05:25:11.304423. The processing

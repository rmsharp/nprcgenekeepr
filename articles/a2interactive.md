...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpk2QaUX/lowParentAge.csv.
...
The current date and time is 2026-08-01 21:43:26.494376. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmplUSssd/lowParentAge.csv.
...
The current date and time is 2026-07-09 04:59:57.24452. The processing

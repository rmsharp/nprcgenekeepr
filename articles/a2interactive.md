...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmppZVHwO/lowParentAge.csv.
...
The current date and time is 2026-08-25 01:34:40.256513. The processing

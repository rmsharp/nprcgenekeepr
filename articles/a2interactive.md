...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpGUecIM/lowParentAge.csv.
...
The current date and time is 2026-06-28 20:07:13.339938. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpaXTjRU/lowParentAge.csv.
...
The current date and time is 2026-07-11 00:00:35.707788. The processing

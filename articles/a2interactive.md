...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpXH3xsA/lowParentAge.csv.
...
The current date and time is 2026-08-03 21:02:40.752607. The processing

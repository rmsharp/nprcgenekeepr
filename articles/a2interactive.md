...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp5vyJ77/lowParentAge.csv.
...
The current date and time is 2026-07-10 04:38:15.310488. The processing

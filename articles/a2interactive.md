...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpyDKHoE/lowParentAge.csv.
...
The current date and time is 2026-07-05 22:07:02.57551. The processing

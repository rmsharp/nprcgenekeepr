...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpC4wHkR/lowParentAge.csv.
...
The current date and time is 2026-07-16 06:10:20.983979. The processing

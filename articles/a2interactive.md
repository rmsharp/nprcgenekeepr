...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpgCdY3D/lowParentAge.csv.
...
The current date and time is 2026-06-30 02:14:21.016436. The processing

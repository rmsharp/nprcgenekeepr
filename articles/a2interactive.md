...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp5VAaK0/lowParentAge.csv.
...
The current date and time is 2026-07-09 20:48:39.743749. The processing

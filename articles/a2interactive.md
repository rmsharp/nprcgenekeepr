...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpRaTwBj/lowParentAge.csv.
...
The current date and time is 2026-07-09 02:34:21.326788. The processing

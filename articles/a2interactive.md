...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpXjEnTx/lowParentAge.csv.
...
The current date and time is 2026-07-10 05:17:09.500822. The processing

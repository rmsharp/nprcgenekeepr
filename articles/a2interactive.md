...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp54rSkQ/lowParentAge.csv.
...
The current date and time is 2026-07-17 03:23:15.520555. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmps5ttZJ/lowParentAge.csv.
...
The current date and time is 2026-07-04 20:29:25.036741. The processing

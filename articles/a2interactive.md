...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpTwS0gf/lowParentAge.csv.
...
The current date and time is 2026-06-25 10:27:23.444815. The processing

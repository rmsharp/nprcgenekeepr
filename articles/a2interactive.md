...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpKCJ0VK/lowParentAge.csv.
...
The current date and time is 2026-07-05 14:02:36.481358. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpgpPAN4/lowParentAge.csv.
...
The current date and time is 2026-06-23 19:27:16.010404. The processing

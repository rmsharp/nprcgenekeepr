...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp6J0bKU/lowParentAge.csv.
...
The current date and time is 2026-06-22 02:06:55.595684. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpG6lKjK/lowParentAge.csv.
...
The current date and time is 2026-07-11 01:33:08.294923. The processing

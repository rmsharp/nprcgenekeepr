...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpsTHXOi/lowParentAge.csv.
...
The current date and time is 2026-06-27 18:59:07.133595. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpsicOGg/lowParentAge.csv.
...
The current date and time is 2026-07-09 19:08:39.150511. The processing

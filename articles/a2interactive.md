...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpt1j4Ca/lowParentAge.csv.
...
The current date and time is 2026-06-24 18:05:08.215693. The processing

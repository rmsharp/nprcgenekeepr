...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpDMilx4/lowParentAge.csv.
...
The current date and time is 2026-07-10 21:05:38.096012. The processing

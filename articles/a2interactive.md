...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpufeLE4/lowParentAge.csv.
...
The current date and time is 2026-07-17 14:57:14.681055. The processing

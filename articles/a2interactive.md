...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpXNCyRL/lowParentAge.csv.
...
The current date and time is 2026-06-19 20:58:41.72498. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp82H1gS/lowParentAge.csv.
...
The current date and time is 2026-08-26 19:55:10.44395. The processing

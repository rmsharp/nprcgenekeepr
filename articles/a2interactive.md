...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmptAA5SJ/lowParentAge.csv.
...
The current date and time is 2026-08-22 20:24:41.15237. The processing

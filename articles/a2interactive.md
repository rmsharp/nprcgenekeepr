...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp29WBSR/lowParentAge.csv.
...
The current date and time is 2026-06-28 13:16:54.392509. The processing

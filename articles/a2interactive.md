...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpXJRroN/lowParentAge.csv.
...
The current date and time is 2026-08-25 01:41:44.531842. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpBAqUzp/lowParentAge.csv.
...
The current date and time is 2026-07-05 00:13:23.616026. The processing

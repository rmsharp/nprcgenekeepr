...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp41bnn9/lowParentAge.csv.
...
The current date and time is 2026-06-28 21:28:15.108875. The processing

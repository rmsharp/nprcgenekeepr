...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpKQkv62/lowParentAge.csv.
...
The current date and time is 2026-07-12 20:56:23.939007. The processing

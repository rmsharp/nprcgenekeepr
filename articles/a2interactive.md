...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpauS0pB/lowParentAge.csv.
...
The current date and time is 2026-07-07 04:40:59.706037. The processing

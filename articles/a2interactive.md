...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpmrkkgi/lowParentAge.csv.
...
The current date and time is 2026-06-21 07:21:12.996419. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpjqRo5Z/lowParentAge.csv.
...
The current date and time is 2026-07-28 19:04:47.128154. The processing

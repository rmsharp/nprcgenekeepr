...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpQVnKBQ/lowParentAge.csv.
...
The current date and time is 2026-06-30 21:44:16.206362. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpaNipdh/lowParentAge.csv.
...
The current date and time is 2026-09-18 02:18:30.281273. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp12aShc/lowParentAge.csv.
...
The current date and time is 2026-07-08 02:13:18.760626. The processing

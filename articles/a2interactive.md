...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpjHIAqn/lowParentAge.csv.
...
The current date and time is 2026-07-08 19:59:36.2448. The processing

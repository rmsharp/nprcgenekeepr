...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpaEhLoo/lowParentAge.csv.
...
The current date and time is 2026-07-12 05:11:47.143806. The processing

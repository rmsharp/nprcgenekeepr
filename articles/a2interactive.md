...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpFmHtE2/lowParentAge.csv.
...
The current date and time is 2026-08-11 22:43:02.0764. The processing

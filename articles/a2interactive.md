...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp18C60W/lowParentAge.csv.
...
The current date and time is 2026-07-12 18:57:01.521884. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp8DrZH9/lowParentAge.csv.
...
The current date and time is 2026-07-01 03:20:55.425383. The processing

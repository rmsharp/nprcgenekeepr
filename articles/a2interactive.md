...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpBvEgd7/lowParentAge.csv.
...
The current date and time is 2026-07-07 05:55:41.252549. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpGuTx1i/lowParentAge.csv.
...
The current date and time is 2026-07-10 01:54:40.832764. The processing

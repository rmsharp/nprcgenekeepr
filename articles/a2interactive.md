...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpj1i2ph/lowParentAge.csv.
...
The current date and time is 2026-07-05 00:01:28.929226. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpGEj8AF/lowParentAge.csv.
...
The current date and time is 2026-07-01 00:46:23.496746. The processing

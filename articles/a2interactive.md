...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpCa49BC/lowParentAge.csv.
...
The current date and time is 2026-06-25 10:33:45.994112. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpjilbUA/lowParentAge.csv.
...
The current date and time is 2026-06-30 23:17:18.359986. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpUDgFEm/lowParentAge.csv.
...
The current date and time is 2026-07-11 22:30:07.201124. The processing

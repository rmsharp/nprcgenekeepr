...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpm1axLp/lowParentAge.csv.
...
The current date and time is 2026-07-07 19:48:09.706992. The processing

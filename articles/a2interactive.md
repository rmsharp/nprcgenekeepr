...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpQniSpe/lowParentAge.csv.
...
The current date and time is 2026-07-15 21:17:15.664039. The processing

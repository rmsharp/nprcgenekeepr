...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpjSPffv/lowParentAge.csv.
...
The current date and time is 2026-06-26 17:47:14.24098. The processing

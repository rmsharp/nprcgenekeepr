...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpy9jLT8/lowParentAge.csv.
...
The current date and time is 2026-09-17 18:59:46.890549. The processing

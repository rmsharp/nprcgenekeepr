...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpjOXAJV/lowParentAge.csv.
...
The current date and time is 2026-07-08 23:37:08.851608. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpjDKjxW/lowParentAge.csv.
...
The current date and time is 2026-07-09 15:51:52.471622. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpScy1rb/lowParentAge.csv.
...
The current date and time is 2026-08-15 17:39:48.71767. The processing

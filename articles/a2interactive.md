...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpDLp8U5/lowParentAge.csv.
...
The current date and time is 2026-09-24 21:24:30.830744. The processing

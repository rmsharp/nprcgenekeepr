...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpqDAk74/lowParentAge.csv.
...
The current date and time is 2026-07-15 01:05:15.298974. The processing

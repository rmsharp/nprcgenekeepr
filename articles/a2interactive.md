...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp1WqbXX/lowParentAge.csv.
...
The current date and time is 2026-07-09 18:07:33.459159. The processing

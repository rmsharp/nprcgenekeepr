...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpIIYLum/lowParentAge.csv.
...
The current date and time is 2026-06-21 02:27:38.41549. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpi6wdwZ/lowParentAge.csv.
...
The current date and time is 2026-07-06 20:21:44.576237. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpeZO1Af/lowParentAge.csv.
...
The current date and time is 2026-06-28 02:42:21.991539. The processing

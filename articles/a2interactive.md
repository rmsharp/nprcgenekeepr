...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpihe4hw/lowParentAge.csv.
...
The current date and time is 2026-07-01 02:02:18.108329. The processing

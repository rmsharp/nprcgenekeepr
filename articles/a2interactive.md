...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpzCaJwq/lowParentAge.csv.
...
The current date and time is 2026-07-06 20:46:21.343792. The processing

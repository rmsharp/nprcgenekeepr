...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpjcpmTH/lowParentAge.csv.
...
The current date and time is 2026-07-05 14:23:54.928378. The processing

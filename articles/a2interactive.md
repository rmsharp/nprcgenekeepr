...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpfmGsxP/lowParentAge.csv.
...
The current date and time is 2026-08-01 18:39:16.948165. The processing

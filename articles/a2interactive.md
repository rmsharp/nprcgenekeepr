...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpTSYF2y/lowParentAge.csv.
...
The current date and time is 2026-09-26 21:25:27.429025. The processing

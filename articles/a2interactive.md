...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpxnaXaq/lowParentAge.csv.
...
The current date and time is 2026-07-04 18:53:03.852805. The processing

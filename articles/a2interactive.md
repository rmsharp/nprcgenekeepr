...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp5nDTET/lowParentAge.csv.
...
The current date and time is 2026-08-02 07:14:12.824432. The processing

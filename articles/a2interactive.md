...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpzZkHsL/lowParentAge.csv.
...
The current date and time is 2026-06-28 23:11:55.575268. The processing

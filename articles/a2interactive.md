...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpG9JpmZ/lowParentAge.csv.
...
The current date and time is 2026-07-30 22:55:15.07585. The processing

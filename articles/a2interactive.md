...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpaSbV2M/lowParentAge.csv.
...
The current date and time is 2026-07-06 22:28:20.148973. The processing

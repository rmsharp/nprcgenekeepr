...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpGj5CX2/lowParentAge.csv.
...
The current date and time is 2026-07-09 04:52:48.773669. The processing

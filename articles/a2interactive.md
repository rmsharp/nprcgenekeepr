...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpRv2zTE/lowParentAge.csv.
...
The current date and time is 2026-07-12 04:57:16.077517. The processing

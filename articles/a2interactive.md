...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpuSdXSq/lowParentAge.csv.
...
The current date and time is 2026-09-21 14:54:25.236609. The processing

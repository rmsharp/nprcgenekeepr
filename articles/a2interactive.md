...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpPAeWjW/lowParentAge.csv.
...
The current date and time is 2026-08-09 11:35:24.278088. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpYcgUFc/lowParentAge.csv.
...
The current date and time is 2026-08-04 03:59:40.056454. The processing

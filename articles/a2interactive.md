...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpvr2aCD/lowParentAge.csv.
...
The current date and time is 2026-06-22 18:46:03.195518. The processing

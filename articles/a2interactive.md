...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpFedSXB/lowParentAge.csv.
...
The current date and time is 2026-08-26 02:52:21.316667. The processing

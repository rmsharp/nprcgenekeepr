...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpUowTMt/lowParentAge.csv.
...
The current date and time is 2026-08-04 02:38:21.757162. The processing

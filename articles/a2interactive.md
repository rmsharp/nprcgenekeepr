...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpjleDRv/lowParentAge.csv.
...
The current date and time is 2026-09-24 19:22:53.395372. The processing

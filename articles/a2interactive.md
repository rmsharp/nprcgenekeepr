...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpjmJOn1/lowParentAge.csv.
...
The current date and time is 2026-07-06 21:13:32.573627. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpxrcCS1/lowParentAge.csv.
...
The current date and time is 2026-06-22 21:53:30.87149. The processing

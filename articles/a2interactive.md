...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmprMPebI/lowParentAge.csv.
...
The current date and time is 2026-07-06 02:10:27.332976. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpO9yPIn/lowParentAge.csv.
...
The current date and time is 2026-08-26 19:47:49.470635. The processing

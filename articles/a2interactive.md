...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpKnnQo8/lowParentAge.csv.
...
The current date and time is 2026-06-22 18:51:42.891412. The processing

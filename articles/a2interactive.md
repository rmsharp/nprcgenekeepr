...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmplxis6N/lowParentAge.csv.
...
The current date and time is 2026-07-12 18:08:28.798492. The processing

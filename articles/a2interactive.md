...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpwW682o/lowParentAge.csv.
...
The current date and time is 2026-07-17 14:41:32.601007. The processing

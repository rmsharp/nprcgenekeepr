...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmplUp7UR/lowParentAge.csv.
...
The current date and time is 2026-06-30 02:22:47.215439. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpy1TV4I/lowParentAge.csv.
...
The current date and time is 2026-07-10 00:47:38.604574. The processing

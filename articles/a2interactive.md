...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpizU9F3/lowParentAge.csv.
...
The current date and time is 2026-07-08 22:09:43.545226. The processing

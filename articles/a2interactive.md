...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmplvYTSP/lowParentAge.csv.
...
The current date and time is 2026-08-02 01:32:04.778053. The processing

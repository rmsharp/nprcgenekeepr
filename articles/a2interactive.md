...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmp8JeF9f/lowParentAge.csv.
...
The current date and time is 2026-06-22 18:39:10.099782. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/RtmpfzPq2Y/lowParentAge.csv.
...
The current date and time is 2026-07-11 21:26:40.157815. The processing

...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpi6vTJl/lowParentAge.csv.
...
The current date and time is 2026-06-20 04:23:49.495175. The processing

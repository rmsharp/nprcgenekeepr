...
```
    ...
    ## Error in `qcStudbook()`:
    ## ! Parents with low age at birth of offspring are listed in /tmp/Rtmpc004Vq/lowParentAge.csv.
...
The current date and time is 2026-07-13 01:18:47.686212. The processing

...
`docs/planning/pedigree-diagram- walker-bjl-apportioning-redesign-plan.md`
§Migration Path Phase 3 (Commit 3-1: production call-site swap + 3
merged/re-pinned test files; Commit 3-2, conditional: 2 files’
defect-count re-pins; required live-render verification via
`helper-live-render-positions.R`). (IN PROGRESS) **Started:** 2026-08-20

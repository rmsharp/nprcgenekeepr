...
active_task: Fix CLAUDE.md's "Clean regression read" command to prepend pkgload::load_all(".", quiet=TRUE), per Learning 377.
what_was_done: pending
next_steps: pending
key_files: CLAUDE.md (the "Clean regression read" row)
gotchas: pending

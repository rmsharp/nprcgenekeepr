...
active_task: Regenerate man/filterPairs.Rd via a standalone devtools::document() run (BACKLOG.md tiny item, Effort XS) -- fixes the stale usage line left by S367's filterPairs() default-arg change.

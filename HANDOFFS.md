...
active_task: IN PROGRESS -- implement issue #131 (add diagram image/print export to the Pedigree Diagram tab), owner-picked via Phase 0 priorities AskUserQuestion. PRE-RED research beginning.

...
active_task: Characterize the founder-positioning defect (BACKLOG.md, found S463) against real bundled pedigree fixtures -- audit-style investigation, no code changes -- following AUDIT_WORKSTREAM.md. Owner noted mid-claim that this codebase's established convention for one individual needing multiple-level representation is node duplication (the existing D6/S461 mechanism), reframing the audit's research angle.

...
active_task: Resolve BACKLOG.md's "Tracker reconciliation" (DECISION NEEDED) item -- decide whether the remaining XARCH architecture findings get filed as GitHub issues or stay BACKLOG-only.

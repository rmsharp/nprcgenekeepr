...
test_that("getErrorTab returns a tabPanel", {
  skip("getErrorTab requires specific errorLst format from qcStudbook")

  # This test verifies getErrorTab exists and is exported
  expect_true(is.function(getErrorTab))
})

test_that("getChangedColsTab returns a tabPanel", {
  skip("getChangedColsTab requires specific errorLst format from qcStudbook")

  # This test verifies getChangedColsTab exists and is exported
  expect_true(is.function(getChangedColsTab))
})

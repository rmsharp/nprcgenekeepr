...
- All tests were repeated with the results recorded in “Test
  environments” immediately below.

## Test environments

- local OS X install, R 4.0.4 – 0 errors \| 0 warnings \| 0 note
- travis-ci R version 4.0.2 (2020-06-22) platform: x86_64-pc-linux-gnu
  (64-bit)
...
- winbuilder using R version 3.6.3 (2020-02-29) using platform:
  x86_64-w64-mingw32 (64-bit) – Status: OK
- winbuilder R Under development (unstable) (2021-03-27 r80128) using
  platform: x86_64-w64-mingw32 (64-bit) – Status: OK
...
- Some test systems are reading historical sections of the NEWS file and
  falsely identifying an old URL as possibly incorrect. Please ignore
  the note.

...
1.  Next for Mark is to create the function to use the output of 
    __countKinshipValues__ to get summary statistics and a function to create
    histograms. The function to create histograms is of lower priority.

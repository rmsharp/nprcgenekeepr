...
| [`/grill-me`](https://github.com/mattpocock/skills/tree/main/skills/productivity/grill-me) | [`ITERATIVE_METHODOLOGY.md`](docs/methodology/ITERATIVE_METHODOLOGY.md) §Phase 2.5 (optional Pre-Create Grill) | `skills/productivity/grill-me` | `62f43a18177b` (2026-04-28) |
...
| [`/triage`](https://github.com/mattpocock/skills/tree/main/skills/engineering/triage) | [`workstreams/DEVELOPMENT_WORKSTREAM.md`](docs/methodology/workstreams/DEVELOPMENT_WORKSTREAM.md) §Issue Lifecycle | `skills/engineering/triage` | `179a14e72103` (2026-04-28) |
| [`/improve-codebase-architecture`](https://github.com/mattpocock/skills/tree/main/skills/engineering/improve-codebase-architecture) | [`workstreams/ARCHITECTURE_WORKSTREAM.md`](docs/methodology/workstreams/ARCHITECTURE_WORKSTREAM.md) §Refactor Heuristics | `skills/engineering/improve-codebase-architecture` | `a36584e09eae` (2026-05-20) |
...
| `/run` | [`SESSION_RUNNER.md`](SESSION_RUNNER.md) §Phase 3E — companion to `/verify`; [`BOOTSTRAP.md`](https://github.com/rmsharp/methodology/blob/main/starter-kit/BOOTSTRAP.md) — runtime drive guidance |
| `/init` | [`BOOTSTRAP.md`](https://github.com/rmsharp/methodology/blob/main/starter-kit/BOOTSTRAP.md) Step 4 — initializing `CLAUDE.md` |
| `/code-review` | [`workstreams/AUDIT_WORKSTREAM.md`](docs/methodology/workstreams/AUDIT_WORKSTREAM.md) — correctness review |
| `/review` | [`workstreams/AUDIT_WORKSTREAM.md`](docs/methodology/workstreams/AUDIT_WORKSTREAM.md) — PR review |
| `/security-review` | [`workstreams/AUDIT_WORKSTREAM.md`](docs/methodology/workstreams/AUDIT_WORKSTREAM.md) — security review |
...
*The audit that motivated this index is [`docs/audits/2026-05-02-mattpocock-skills-evaluation.md`](https://github.com/rmsharp/methodology/blob/main/docs/audits/2026-05-02-mattpocock-skills-evaluation.md).*

#!/usr/bin/env bash
# Losslessness proof for docs/archive/SESSION_NOTES-through-2026-09-18.md — generated by methodology_trim.py v1.1.2.
#
...
SHARD=docs/archive/SESSION_NOTES-through-2026-09-18.md
INJECTED=0

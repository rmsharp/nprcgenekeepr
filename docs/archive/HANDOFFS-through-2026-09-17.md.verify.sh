#!/usr/bin/env bash
# Losslessness proof for docs/archive/HANDOFFS-through-2026-09-17.md — generated by methodology_trim.py v1.1.2.
#
...
LIVE=HANDOFFS.md
SHARD=docs/archive/HANDOFFS-through-2026-09-17.md
INJECTED=0

#!/usr/bin/env bash
# Losslessness proof for docs/archive/SESSION_NOTES-through-2026-09-21-2.md — generated by methodology_trim.py v1.5.0.
#
...
SHARD=docs/archive/SESSION_NOTES-through-2026-09-21-2.md
...
RECORD_KIND = "heading"
RECORD_START = r"^### (?:Session \d+ Handoff Evaluation \(by Session \d+\)|What Session \d+ Did\b)"
FENCE_INFO = ""
FOOTER_MODE = "none"
PREFIX = "../../"

#!/usr/bin/env bash
# Losslessness proof for docs/archive/SESSION_NOTES-through-2026-09-23-2.md — generated by methodology_trim.py v1.5.0.
#
...
SHARD=docs/archive/SESSION_NOTES-through-2026-09-23-2.md

...
- Development continues here while CRAN’s 2.0.0 submission (2026-07-17,
  tagged `v2.0.0`) is under review. If CRAN requires a resubmission, it
  will ship as 2.0.1, not a second 2.0.0 attempt.

...
- Cleaned code based in lintr feedback and added use of lintr in GitHub
...
- winbuilder using R Under development (unstable) (2024-12-19 r87451
  ucrt) using platform: x86_64-w64-mingw32 (64-bit)
- winbuilder using R version 4.4.2 (2024-10-31 ucrt) using platform:
  x86_64-w64-mingw32
- winbuilder using R version 4.3.3 (2024-02-29 ucrt) using platform:
  x86_64-w64-mingw32 (64-bit)
- Rhub environments on 2024-12-19
  - success:
    - linux, macos, macos-arm64, windows, atlas, c23, clang-asan,
      clang16, clang17, clang18, clang19, clang20, donttest, gcc13,
      gcc14, intel, mkl, nold, noremap, ubuntu-clang, ubuntu-gcc12,
      ubuntu-next, ubuntu-release, valgrind
  - failed:
    - nosuggests, rchk

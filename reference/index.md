...
- [`addSexAndAgeToGroup()`](https://github.com/rmsharp/nprcgenekeepr/reference/addSexAndAgeToGroup.md)
  : Forms a dataframe with Id, Sex, and current Age given a list of Ids
  and a pedigree
...
- [`calculateSexRatio()`](https://github.com/rmsharp/nprcgenekeepr/reference/calculateSexRatio.md)
  : Calculates the sex ratio (number of non-males / number of males)
...
- [`convertFromCenter()`](https://github.com/rmsharp/nprcgenekeepr/reference/convertFromCenter.md)
...
- [`filterThreshold()`](https://github.com/rmsharp/nprcgenekeepr/reference/filterThreshold.md)
  : Filters kinship to remove rows with kinship values less than the
  specified threshold
...
- [`getChangedColsTab()`](https://github.com/rmsharp/nprcgenekeepr/reference/getChangedColsTab.md)
...
- [`getIdsWithOneParent()`](https://github.com/rmsharp/nprcgenekeepr/reference/getIdsWithOneParent.md)
  : getIdsWithOneParent extracts IDs of animals pedigree without either
  a sire or a dam
...
- [`kinshipMatrixToKValues()`](https://github.com/rmsharp/nprcgenekeepr/reference/kinshipMatrixToKValues.md)
  : Extracts a dataframe with a row for each kinship coeficient in the
  kinship matrix
...
- [`makeCEPH()`](https://github.com/rmsharp/nprcgenekeepr/reference/makeCEPH.md)
...
- [`modGvAndBgDescServer()`](https://github.com/rmsharp/nprcgenekeepr/reference/modGvAndBgDescServer.md)
  : Genetic Value and Breeding Group Description Module - Server
  Function
...
- [`removeEarlyDates()`](https://github.com/rmsharp/nprcgenekeepr/reference/removeEarlyDates.md)
  : removeEarlyDates removes dates before a specified year

- [`removePotentialSires()`](https://github.com/rmsharp/nprcgenekeepr/reference/removePotentialSires.md)
...
- [`set_seed()`](https://github.com/rmsharp/nprcgenekeepr/reference/set_seed.md)
  : Work around for unit tests using sample() among various versions of
  R
...
- [`trimPedigree()`](https://github.com/rmsharp/nprcgenekeepr/reference/trimPedigree.md)
  : Trim pedigree to ancestors of provided group by removing
  uninformative individuals

- [`withinIntegerRange()`](https://github.com/rmsharp/nprcgenekeepr/reference/withinIntegerRange.md)

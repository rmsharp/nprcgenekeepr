...
- Fixed: in the Pedigree Diagram tab's Rectilinear edge style, a sibship
  ...
  common 1-generation-gap case. A rare residual can still occur for a
  union placed an exact multiple of 5 generations from its child; tracked
  for a future general same-row collision-avoidance pass.

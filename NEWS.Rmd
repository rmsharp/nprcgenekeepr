...
-   Minor changes
    ...
    -   Corrected getPedDirectRelative() so that all direct relatives are found.
        Supplemented unit tests for more direct relative types.
...
-   Minor changes
    ...
    -   Functions were refactored and the ability to handle larger simulations 
        resulted.
...
-   Major changes
    -   Added ability to use simulation to estimate the kinship values of 
        ...
        _fromcenter_ or _fromCenter_ field of "Y", "YES", "T", or "TRUE".
-   Minor changes
    -   Increase unit test coverage primarily to include more rare events and 
        events that should not happen and are trapped and result in errors.

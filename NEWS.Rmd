...
- Fixed: `removeUnknownAnimals()`, which removes the animals that were added
  as stand-ins for unknown parents, no longer returns an empty pedigree when
  the pedigree has no record of which animals were added. It now returns the
  pedigree as it was, since none of its animals were added.

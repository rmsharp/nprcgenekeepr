...
Planned capabilities[^transloc] will provide
...
[^transloc]: A planned capability will use timestamped transactional location data to identify potential parents for animals with a missing parent.

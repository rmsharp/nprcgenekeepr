...
This vignette provides a quick example of how to estimate kinship cooefficients
...
occurance in colonies of which we are aware.
...
Only those IDs that have unknown parents are included in the simParent_n lists.
For those IDs with one known parent, the known parent is included in the 
simParent_n. See \code{simParent_1} for ID \code{A}. 
...
number of times each parent is included in the simParent_n list.

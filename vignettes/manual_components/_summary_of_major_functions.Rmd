...
Two configuration files are needed to use the database features of mprcgenekeepr
with LabKey. 
...
`mprcgenekeepr` 
[configuration file](
https://github.com/rmsharp/mprcgenekeepr/blob/master/inst/extdata/example_mprcgenekeepr_config)

...
We reuse the _trimmedPed_ pedigree built earlier in this tutorial, which
already has the __gen__ column __makePedigreeDiagramData__ requires.
...
Diagram (PNG)__ button -- try it below.[^4]

[^4]: The Diagram tab's click-to-navigate behavior (clicking a node narrows
...
useful for locating one animal in a diagram this size (`r nrow(trimmedPed)`

---
title: "Interactive Use of mprcgenekeepr"
...
vignette: >
  ...
  %\VignetteIndexEntry{Interactive Use of mprcgenekeepr} 
...
within the Shiny application provided by the __mprcgenekeepr__ package and
...
issue tracker at 
[https://github.com/rmsharp/mprcgenekeepr/issues](
https://github.com/rmsharp/mprcgenekeepr/issues).


## Installation and Help

You can install **mprcgenekeepr** from GitHub with the following code.
...
# devtools::install_github("rmsharp/mprcgenekeepr")
```
...
?mprcgenekeepr
```
__The help provided by this (_mprcgenekeepr.R_) needs to be more complete 
...
The primary purpose of __mprcgenekeepr__ is to form breeding groups 
...
__mprcgenekeepr__, which we will examine using code below.
...
```{r list-pedOne}
knitr::kable(mprcgenekeepr::pedOne)
```
...
pedOne <- mprcgenekeepr::pedOne # put it in the local environment

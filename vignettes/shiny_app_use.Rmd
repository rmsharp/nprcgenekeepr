...
knitr::opts_chunk$set(eval = FALSE, echo = TRUE, results = "markup",
                      cache = FALSE)
...
`r fig_alt_txt <- "Top part of opening screen"`

```{r eopening-screen-top, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 6.5, echo = FALSE}
...
`r fig_alt_txt <- "Middle part of opening screen"`

```{r fig-opening-screen-middle, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 6.5, echo = FALSE}
...
`r fig_alt_txt <- "Bottom part of opening screen"`

```{r fig-opening-screen-bottom, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 5.5, echo = FALSE}
...
`r fig_alt_txt <- "Example pedigree tutorial without genotypes"`

```{r fig-examplePedigreeTutorial, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 5.5, fig.height = 2, echo = FALSE}
...
`r fig_alt_txt <- "Example pedigree tutorial with genotypes"`

```{r eexamplePedigreeTutorial-with_alleles, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 5.5, fig.height = 2, echo = FALSE}
...
`r fig_alt_txt <- "Top red oval in opening screen"`

```{r fig-opening-screen-top-red-oval, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 5.5, echo = FALSE}
...
`r fig_alt_txt <- "Input of example pedigree in Excel format"`

```{r example-pedigree, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 2.5, echo = FALSE}
...
`r fig_alt_txt <- "Input of minimum parent age"`

```{r example-pedigree-minParentAgeSequence, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 11, echo = FALSE}
...
`r fig_alt_txt <- "Read and check pedigree"`

```{r read-and-check-pedigree, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 2.5, echo = FALSE}
...
```{r}
fig_alt_txt <- "Pedigree browser with 10 rows displayed and unknown IDs shown"
```

```{r pb-10-rows-display-unknown-ids, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 5.5, echo = FALSE}
...
`r fig_alt_txt <- "Pedigree browser unknown IDs displayed"`

```{r unknown-displayed, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 5, fig.height = 2, echo = FALSE}
...
```{r no-unknown-displayed, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 5, fig.height = 2, echo = FALSE}
...
```{r focal-animal-text-box, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 5, echo = FALSE}
...
Trimming the pedigree based on focal animals will keep only animals in the
pedigree that are related to the focal animals selected.
...
```{r selection-large-focal-group, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 4, fig.height = 2, echo = FALSE}
...
```{r select-trim-for-focal-animals, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 6, echo = FALSE}
...
```{r trimmed-for-focal-animals, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 4, fig.height = 2, echo = FALSE}
...
```{r}
fig_alt_txt <- paste0("Pedigree browser showing two screens; one with focal ",
...
```{r age-plot, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 8.0, echo = FALSE}
...
```{r gva-calculating, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 8, echo = FALSE}
...
```{r gva-first-high-value, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 8.0, echo = FALSE}
...
```{r gva-high-and-low-value, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 5.5, fig.height = 1.5, echo = FALSE}
...
```{r ss-first-view, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 8.0, echo = FALSE}
...
```{r ss-kinship-matrix, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 6, fig.height = 2, echo = FALSE}
...
```{r first-order-relationships, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 5, echo = FALSE}
...
```{r female-founders, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 5, fig.height = 2, echo = FALSE}
...
```{r ss-trimmed-all-plots, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 8, echo = FALSE}
...
```{r breeding-group-first-view, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 7, echo = FALSE}
...
```{r breeding-group-1, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 8, echo = FALSE}
...
```{r breeding-group-6-infants-with-dam, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 6, echo = FALSE}
...
```{r bg-no-kinship-seeds-indicated, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 8.5, echo = FALSE}
img <- png::readPNG(
...
```{r bg-6-seed-grps-grp-6-kinship, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 8.5, echo = FALSE}
img <-
  png::readPNG("./shiny_app_use/breeding_group_6_seed_grps_grp_6_kinship.png")
grid::grid.raster(img)
...
```{r fig-bg-ratio, eval = TRUE, fig.alt = fig_alt_txt, fig.width = 5.5, echo = FALSE}
img <-
  png::readPNG("./shiny_app_use/breeding_group_sex_ratio_specification.png")
grid::grid.raster(img)
```                                                                                      

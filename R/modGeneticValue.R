             ...
             wellPanel(
               ...
               helpText(
                 ...
                 paste("The gene-drop convergence diagnostic gvaConvergence()",
                       ...
                       "overridden kinship."),
                 paste("For an animal missing one parent, an override only",
                       "refines that pair's kinship value; the unknown-parent",
                       "correction is kept for every such animal. Mean kinship",
                       "for a one-parent-unknown animal is an estimate that",
                       "tends to underestimate relatedness, since the unknown",
                       "parent's relatives are unrecorded (Vinson & Raboin",
                       "2015).")
               )
             ),
             wellPanel(

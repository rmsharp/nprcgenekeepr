...
#' \code{inst/extdata/examples/example_nprcgenekeepr_config}). The call is
#' wrapped in \code{tryCatch} so that a missing or malformed configuration
#' file can never crash the application on boot: in that case a warning is

...
#' Return default (no-config) site parameters
#'
...
#' \code{inst/extdata/examples/example_nprcgenekeepr_config}.
#' \code{mapPedColumns} is the one-to-one rename of \code{lkPedColumns} to the
#' package's internal names.
#'

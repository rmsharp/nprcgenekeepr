...
- **Documentation engine: Hybrid (Quarto + R Markdown)** — adopted 2026-06-17, Option B of
  ...
  **Articles so far (S107–S108):** `breeding-group-formation.qmd`, `genetic-value-analysis.qmd`
  — each a scripted, non-Shiny walkthrough on shipped `examplePedigree` data; adding more is a

...
- [ ] **Sequencing decision (owner-directed, S428, 2026-07-29):** #126 is now
      ...
      **Implementing Slice 3 (Mendelian-exclusion parentage verification)
      ...
      428-430.
      **Implementing Slice 4 (cross-center identity linking, fully
      independent) or Slice 5 (cross-center differentiation statistic,
      depends on Slice 1, now shipped) is next (READY, Effort M each)** --
      no other open item in this sequencing chain remains.

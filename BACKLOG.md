...
- [ ] **Slice 2 of the issue #125 plan -- surface multiple breeding-group
      ...
      phase-gated). Independent of Slice 1 (S424, DONE -- see
      `CHANGELOG.md`) -- do not bundle. Closes issue #125 when done.
...
- [ ] (none remaining -- all actionable items tracked via GitHub issues #125-#130 above.)

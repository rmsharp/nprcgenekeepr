...
- [ ] **CRAN resubmission of v2.0.0** (DECISION NEEDED -- owner-only, but a
      ...
      `0 errors | 0 warnings | 1 note`. Next: dispatch a fresh win-builder
      Windows-devel check to confirm the real combined impact -- see
      `cran-comments.md` for full detail -- before the resubmit/wait/hold
